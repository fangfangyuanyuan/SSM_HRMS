                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio"  name="role" id="role1" value="A"> 管理员
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="role" id="role2" value="T" > 教师
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="role" id="role3" value="S"  checked="checked"> 学生
                                    </label>
                                </div>
                            </div>
        ...
        $("#login_btn").click(function () {
            ...
            $.ajax({
                ...
                success:function (result) {
                    if(result.code == 100){
                        window.location.href= "/hrms/main?role=" + role;
                    }else {
